...
const TOKEN_REFRESH_WINDOW_SEC = parseInt(process.env.TOKEN_REFRESH_WINDOW_SEC || '604800', 10); // 默认7天
...
function buildTokenMeta(extra = '') {
  ...
  const refreshUntil = new Date(now + TOKEN_REFRESH_WINDOW_SEC * 1000);
